...
public class UserAppointment extends Fragment implements ITimeSlotLoadListener {
    OnAppointmentSelectedListener callback;

    public void setOnAppointmentSelectedListener(OnAppointmentSelectedListener callback)
    {
    ...
    BroadcastReceiver displayTimeSlot = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            loadAvailableTimeSlotofService(Common.currentshop.getShopID(),
                    simpleDateFormat.format(date.getTime()));
        }
    };


    private void loadAvailableTimeSlotofService(String ShopID, final String bookDate) {
        dialog.show();

        ShopDoc = FirebaseFirestore.getInstance()
                .collection("Car Wash Centre")
     ...
     static UserAppointment instance;
    public static UserAppointment getInstance(){
        if (instance == null)
            instance = new UserAppointment();
        return instance;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View itemView = inflater.inflate(R.layout.activity_user_appointment,container,false);
